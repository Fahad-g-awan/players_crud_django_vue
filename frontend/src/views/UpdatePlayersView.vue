...
import { addPlayers, updatePlayers } from "@/utils/composabels/playersApi";
...
onMounted(() => {
  ...
  if (!p) {
    ...
    console.log("teamParam", teamParam.value);
    console.log("teamParam[teamParam]", p[teamParam.value]);
